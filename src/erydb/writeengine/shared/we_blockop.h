...
public:
    ...
    */
    EXPORT int      getCorrectRowWidth( const execplan::erydbSystemCatalog::ColDataType colDataType,
                                    const int width ) const;

   /**
    * @brief Get an empty row value
    */
    EXPORT uint64_t getEmptyRowValue(const execplan::erydbSystemCatalog::ColDataType colDataType,
                                    const int width ) const;
