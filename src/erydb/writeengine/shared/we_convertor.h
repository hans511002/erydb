...
public:
    ...
    */
    //BUG931
    EXPORT static void convertColType(execplan::erydbSystemCatalog::ColDataType dataType,
    ...
    */
    EXPORT static void convertWEColType(ColType internalType, 
        execplan::erydbSystemCatalog::ColDataType& dataType);
    ...
    */
    EXPORT static int getCorrectRowWidth( execplan::erydbSystemCatalog::ColDataType dataType, int width );
