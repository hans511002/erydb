 ...
 ******************************************************************************/
/* static */
void Convertor::convertColType(erydbSystemCatalog::ColDataType dataType,
...
void Convertor::convertWEColType(ColType internalType, 
    erydbSystemCatalog::ColDataType& dataType)
{
    switch(internalType) 
    {
        // Map BIT and TINYINT to WR_BYTE
        case WriteEngine::WR_BYTE :
            dataType = erydbSystemCatalog::TINYINT; break;

        // Map SMALLINT to WR_SHORT
        case WriteEngine::WR_SHORT :
            dataType = erydbSystemCatalog::SMALLINT; break;

        // Map MEDINT, INT, and DATE to WR_INT
        case WriteEngine::WR_INT :
            dataType = erydbSystemCatalog::INT; break;

        // Map FLOAT and UFLOAT to WR_FLOAT
        case WriteEngine::WR_FLOAT:
            dataType = erydbSystemCatalog::FLOAT; break;

        // Map BIGINT and DATETIME to WR_LONGLONG
        case WriteEngine::WR_LONGLONG :
            dataType = erydbSystemCatalog::BIGINT; break;

        // Map DOUBLE and UDOUBLE to WR_DOUBLE
        case WriteEngine::WR_DOUBLE :
            dataType = erydbSystemCatalog::DOUBLE; break;

        // Map BLOB to WR_BLOB
        case WriteEngine::WR_BLOB :
            dataType = erydbSystemCatalog::BLOB; break;

        // Map VARBINARY to WR_VARBINARY
        case WriteEngine::WR_VARBINARY:
            dataType = erydbSystemCatalog::VARBINARY; break;

        // Map CHAR, VARCHAR, and CLOB to WR_CHAR
        case WriteEngine::WR_CHAR :
            dataType = erydbSystemCatalog::CHAR; break;

        // Map UTINYINT to WR_UBYTE
        case WriteEngine::WR_UBYTE:
            dataType = erydbSystemCatalog::UTINYINT; break;

        // Map USMALLINT to WR_USHORT
        case WriteEngine::WR_USHORT:
            dataType = erydbSystemCatalog::USMALLINT; break;

        // Map UMEDINT and UINT to WR_UINT
        case WriteEngine::WR_UINT:
            dataType = erydbSystemCatalog::UINT; break;

        // Map UBIGINT to WR_ULONGLONG
        case WriteEngine::WR_ULONGLONG:
            dataType = erydbSystemCatalog::UBIGINT; break;
...
{
    erydbSystemCatalog::ColDataType dataType     // This will be updated later,
                              = erydbSystemCatalog::CHAR; // CHAR used only for initialization.
 ...
 ******************************************************************************/
/* static */
int Convertor::getCorrectRowWidth(erydbSystemCatalog::ColDataType dataType, int width)
{
    ...
    switch(dataType) {
        ...
        case erydbSystemCatalog::CHAR:
        case erydbSystemCatalog::VARCHAR:
        case erydbSystemCatalog::VARBINARY: // treat same as varchar for now
        default:
            offset = (dataType == erydbSystemCatalog::VARCHAR)? -1 : 0;
            newWidth = 1;
            if (width == (2 + offset))
                newWidth = 2;
 ...
 * this function.  The value for <DBRoot> is stored in the erydb.xml
 * configuration file.
 *
 * PARAMETERS:
