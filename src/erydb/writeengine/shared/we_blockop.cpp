...
uint64_t BlockOp::getEmptyRowValue(
    const erydbSystemCatalog::ColDataType colDataType, const int width ) const
{
    uint64_t emptyVal = 0;
    int offset = 0;

    switch( colDataType ) {
        case erydbSystemCatalog::TINYINT : emptyVal = joblist::TINYINTEMPTYROW; break;
        case erydbSystemCatalog::SMALLINT: emptyVal = joblist::SMALLINTEMPTYROW; break;
        case erydbSystemCatalog::MEDINT :  
        case erydbSystemCatalog::INT :     emptyVal = joblist::INTEMPTYROW; break;
        case erydbSystemCatalog::BIGINT :  emptyVal = joblist::BIGINTEMPTYROW; break;
        case erydbSystemCatalog::FLOAT :
        case erydbSystemCatalog::UFLOAT :   emptyVal = joblist::FLOATEMPTYROW; break;
        case erydbSystemCatalog::DOUBLE :
        case erydbSystemCatalog::UDOUBLE :  emptyVal = joblist::DOUBLEEMPTYROW; break;
...
*/ 
                ...
                break;
        case erydbSystemCatalog::UTINYINT : emptyVal = joblist::UTINYINTEMPTYROW; break;
        case erydbSystemCatalog::USMALLINT: emptyVal = joblist::USMALLINTEMPTYROW; break;
        case erydbSystemCatalog::UMEDINT :  
        case erydbSystemCatalog::UINT :     emptyVal = joblist::UINTEMPTYROW; break;
        case erydbSystemCatalog::UBIGINT :  emptyVal = joblist::UBIGINTEMPTYROW; break;
        ...
        default:
            offset = ( colDataType == erydbSystemCatalog::VARCHAR )? -1 : 0;
