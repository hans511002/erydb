...
private:
    ...
    size_t readFillBuffer    (  ERYDBDataFile* pFile,
                                char*       buffer,
                                size_t      bytesReq) const;
    int restoreHWMChunk      (  ERYDBDataFile* pFile,
                                OID         columnOID,
                                uint32_t   partNum,
                                uint32_t   segNum,
                                ...
                                std::string& errMsg );
    int loadColumnHdrPtrs    (  ERYDBDataFile* pFile,
                                char*       hdrs,
                                compress::CompChunkPtrList& chunkPtrs,
                                std::string& errMsg) const;
    int loadDctnryHdrPtrs    (  ERYDBDataFile* pFile,
                                char*       controlHdr,
                                compress::CompChunkPtrList& chunkPtrs,
                                uint64_t&   ptrHdrSize,
                                std::string& errMsg ) const;
