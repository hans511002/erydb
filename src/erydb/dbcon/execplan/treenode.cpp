...
void TreeNode::resultType ( const execplan::erydbSystemCatalog::ColType& resultType)
{
	fResultType = resultType;

	// set scale/precision for the result
	if (fResultType.colDataType == execplan::erydbSystemCatalog::DECIMAL ||
	    fResultType.colDataType == execplan::erydbSystemCatalog::UDECIMAL)
	{
