...
/* ------------ (dynamic table) to be used in a from cluase.                    ----- */ 
	...
	// Build Group By List
        ...
        csep->location (erydbSelectExecutionPlan::FROM);  // Use scope resolution to use enum.
...
/*  ------ This is the begining of the outer query  ---------------------- */ 
        ...
        erydbSelectExecutionPlan *csep_parent = new erydbSelectExecutionPlan();
        cout << "********* I'm ok to here 01 ***************" << endl; 
        erydbSelectExecutionPlan::ReturnedColumnList colList2;
        erydbSelectExecutionPlan::GroupByColumnList groupbyList2;
        cout << "********* I'm ok to here 02 ***************" << endl; 
        erydbSelectExecutionPlan::OrderByColumnList orderbyList2;
        erydbSelectExecutionPlan::SelectList  subSelectList2;
...
/*  ------ This is the begining of the query filter ---------------------- */ 
        ...
        erydbSelectExecutionPlan::FilterTokenList regFilterTokenList; 
	...
	regFilterTokenList.push_back(f1); 
        ...
        cout << "********* I'm ok to here 1 ***************" << endl; 
        //Sub select filter 
        erydbSelectExecutionPlan *subcsep = 
            new erydbSelectExecutionPlan(erydbSelectExecutionPlan::WHERE);

        //subselect return column(s)
        erydbSelectExecutionPlan::ReturnedColumnList  subColList; 
        ...
        //subselect Filters 
        //erydbSelectExecutionPlan::FilterTokenList subFilterTokenList; 
