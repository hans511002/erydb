...
/* ------------ (dynamic table) to be used in a from cluase.                    ----- */ 
	...
	sub011csep_filterlist.push_back(s011f1); 
        ...
        //Sub select filter 
        erydbSelectExecutionPlan *sub012csep = 
            new erydbSelectExecutionPlan(erydbSelectExecutionPlan::WHERE);

        //subselect return column(s)
        erydbSelectExecutionPlan::ReturnedColumnList  sub012ColList; 
  	...
  	// Append returned columns to subselect 
        ...
        erydbSelectExecutionPlan::FilterTokenList sub012csep_filterlist; 
