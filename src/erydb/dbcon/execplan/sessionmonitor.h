 ...
 * 
 *
 * This class uses 2 parameters from the erydb.xml file:
 ...
 *		The default is /tmp/erydbMonShm.
 */
...
class SessionMonitor {
	public:
		...
		struct SessionManagerData_struct {
			int txnCount;
			erydbSystemCatalog::SCN verID;
			erydbSystemCatalog::SCN syscatVerID;
			int systemstate;
