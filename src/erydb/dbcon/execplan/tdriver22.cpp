...
/* ------------ Starting Query 22 from Here                   ----- */ 
        ...
        SimpleColumn *c1 = new SimpleColumn("erydb.FROMTABLE.cntrycode");
        ...
        // Filter columns (csep)
        erydbSelectExecutionPlan::FilterTokenList csep_filterlist; 

        //   --------------- first sub select begins here ----------------  x
        //Sub select filter 
        erydbSelectExecutionPlan *sub01csep = 
            new erydbSelectExecutionPlan(erydbSelectExecutionPlan::FROM);

        sub01csep->tableAlias("custsale"); 

        //subselect return column(s)
        erydbSelectExecutionPlan::ReturnedColumnList  sub01ColList; 
  	...
  	// Append returned columns to subselect 
        ...
        erydbSelectExecutionPlan::FilterTokenList sub01csep_filterlist; 
	...
	sub01csep_filterlist.push_back(s01f1f); 
        ...
        //Sub select filter 
        erydbSelectExecutionPlan *sub011csep = 
            new erydbSelectExecutionPlan(erydbSelectExecutionPlan::WHERE);

        //subselect return column(s)
        erydbSelectExecutionPlan::ReturnedColumnList  sub011ColList; 
  	...
  	// Append returned columns to subselect 
        ...
        erydbSelectExecutionPlan::FilterTokenList sub011csep_filterlist; 
	...
	sub01csep_filterlist.push_back(s01f2); 
        ...
        //Sub select filter 
        erydbSelectExecutionPlan *sub02csep = 
            new erydbSelectExecutionPlan(erydbSelectExecutionPlan::WHERE);

        //subselect return column(s)
        erydbSelectExecutionPlan::ReturnedColumnList  sub02colList; 
  	...
  	// Append returned columns to subselect 
        ...
        erydbSelectExecutionPlan::FilterTokenList sub02csep_filterlist; 
...
//	sub01csep_filterlist.push_back(s01f1); //Previous added.  
	...
	csep->filterTokenList(csep_filterlist); 
        */
        ...
        erydbSelectExecutionPlan::SelectList subselectlist; 
	...
	// Build Group By List
        ...
        erydbSelectExecutionPlan::GroupByColumnList csep_groupbyList;
	...
	// Order By List
        erydbSelectExecutionPlan::OrderByColumnList csep_orderbyList;
        SimpleColumn *o1 = new SimpleColumn("erydb.FROMTABLE.cntrycode");
