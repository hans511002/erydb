...
/***********************************************************************
*   $Id: erydbselectexecutionplan.h 9576 2013-05-29 21:02:11Z zzhu $
*
*
***********************************************************************/
/** @file */

#ifndef ERYDBSELECTEXECUTIONPLAN_H
#define ERYDBSELECTEXECUTIONPLAN_H
#include <vector>
#include <map>
#include <iosfwd>
...
typedef boost::shared_ptr<erydbSelectExecutionPlan> SCSEP;

/**
 * @brief A class to represent erydb select execution plan
 *
 * This class is a concrete implementation of a erydbExecutionPlan
 * specifically describing a SQL select activity.
 */
class erydbSelectExecutionPlan : public erydbExecutionPlan {
...
public:
	...
	typedef std::vector<erydbSystemCatalog::TableAliasName> TableList;
...
#undef DELETE //Windows defines this...
	...
	*/
	 ...
	 * Constructors
	 */
	erydbSelectExecutionPlan(const int location = MAIN);

	erydbSelectExecutionPlan(const ReturnedColumnList& returnedCols,
	                           ParseTree* filters,
	...
	erydbSelectExecutionPlan (const std::string data);

	/**
	 * Destructors
	 */
	virtual ~erydbSelectExecutionPlan();
	...
	*/
	 ...
	 */
	virtual bool operator==(const erydbExecutionPlan* t) const;
	 ...
	 * @return true iff every member of t is a duplicate copy of every member of this; false otherwise
	 */
	virtual bool operator==(const erydbSelectExecutionPlan& t) const;
...
private:
	...
	ParseTree* fFilters;
	/**
	 * A list of erydbExecutionPlan objects
	 */
...
inline std::ostream& operator<<(std::ostream& os, const erydbSelectExecutionPlan& rhs)
	{ os << rhs.toString(); return os; }

}
#endif //ERYDBSELECTEXECUTIONPLAN_H
// vim:ts=4 sw=4:
