...
/***********************************************************************
 *   $Id: erydbdmlpackage.h 9210 2013-01-21 14:10:42Z rdempsey $
 *
 *
 ***********************************************************************/
/** @file */

#ifndef ERYDBDMLPACKAGE_H
#define ERYDBDMLPACKAGE_H
#include <string>
...
namespace dmlpackage
{
     ...
     * implemetation of a erydbDMLPackage
     */
    class erydbDMLPackage
    {
        ...
        public:
            ...
            /** @brief build a erydbDMLPackage from a parsed SqlStatement
             *
             * @param sqlStatement the parsed SqlStatement
             */
            virtual int buildFromSqlStatement( SqlStatement& sqlStatement ) = 0;

            /** @brief build a erydbDMLPackage from valuelist built from mysql table fields
             *
             ...
             */
            void set_TxnID( execplan::erydbSystemCatalog::SCN txnID ) { fTxnId = txnID; }

            /** @brief get the transaction ID associated with this package
             */
            execplan::erydbSystemCatalog::SCN get_TxnID() const { return fTxnId; }
