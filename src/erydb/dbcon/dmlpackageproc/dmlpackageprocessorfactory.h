...
/** @brief create a DMLPackageProcessor object from a erydbDMLPackage object
 *
 */
...
/** @brief static DMLPackageProcessor constructor method
  ...
  * @param cpackage the erydbDMLPackage from which the DMLPackageProcessor is constructed
  */
  EXPORT static DMLPackageProcessor* 
	makePackageProcessor( int packageType, dmlpackage::erydbDMLPackage& cpackage );
