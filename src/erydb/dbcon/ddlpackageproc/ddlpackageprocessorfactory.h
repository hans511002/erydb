...
/** @brief create a ddlPackageProcessor object from a erydbddlPackage object
 *
 */
...
/** @brief static ddlPackageProcessor constructor method
  ...
  * @param cpackage the erydbddlPackage from which the ddlPackageProcessor is constructed
  */
  static DDLPackageProcessor* 
	makePackageProcessor( int packageType, ddlpackage::erydbDDLPackage& cpackage );
