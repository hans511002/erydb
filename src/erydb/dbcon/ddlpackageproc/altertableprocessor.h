...
namespace ddlpackageprocessor
{
    ...
    class AlterTableProcessor : public DDLPackageProcessor
    {
        public:
             ...
             */
            EXPORT void addColumn(uint32_t sessionID, execplan::erydbSystemCatalog::SCN txnID, DDLResult& result,
             ...
             */
            EXPORT void dropColumn(uint32_t sessionID, execplan::erydbSystemCatalog::SCN txnID, DDLResult& result,
             ...
             * @param fTableName the QualifiedName for the table
             */
            EXPORT void dropColumns(uint32_t sessionID, execplan::erydbSystemCatalog::SCN txnID, DDLResult& result,
             ...
             * @param fTableName the QualifiedName for the table
             */
            EXPORT void addTableConstraint(uint32_t sessionID, execplan::erydbSystemCatalog::SCN txnID, DDLResult& result,
             ...
             * @param fTableName the QualifiedName for the table
             */
            EXPORT void setColumnDefault(uint32_t sessionID, execplan::erydbSystemCatalog::SCN txnID, DDLResult& result,
             ...
             * @param fTableName the QualifiedName for the table
             */
            EXPORT void dropColumnDefault(uint32_t sessionID, execplan::erydbSystemCatalog::SCN txnID, DDLResult& result,
             ...
             * @param fTableName the QualifiedName for the table
             */
            EXPORT void dropTableConstraint(uint32_t sessionID, execplan::erydbSystemCatalog::SCN txnID, DDLResult& result,
             ...
             * @param fTableName the QualifiedName for the table
             */
            EXPORT void renameTable(uint32_t sessionID, execplan::erydbSystemCatalog::SCN txnID,
             ...
             * @param fTableName the QualifiedName for the table
             */
            EXPORT void renameColumn(uint32_t sessionID, execplan::erydbSystemCatalog::SCN txnID, DDLResult& result,
             ...
             * @param fTableName the QualifiedName for the table
             */
            EXPORT void tableComment(uint32_t sessionID, execplan::erydbSystemCatalog::SCN txnID, DDLResult& result,
