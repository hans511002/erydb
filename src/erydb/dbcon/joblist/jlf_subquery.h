...
void addOrderByAndLimit(execplan::erydbSelectExecutionPlan*, JobInfo&);

void doExistsFilter(const execplan::ParseTree*, JobInfo&);

int  doFromSubquery(execplan::erydbExecutionPlan*, const std::string&, const std::string&, JobInfo&);

void doSelectFilter(const execplan::ParseTree*, JobInfo&);

void doSimpleScalarFilter(execplan::ParseTree*, JobInfo&);

void preprocessHavingClause(execplan::erydbSelectExecutionPlan*, JobInfo&);

void preprocessSelectSubquery(execplan::erydbSelectExecutionPlan*, JobInfo&);

SJSTEP doUnionSub(execplan::erydbExecutionPlan*, JobInfo&);
