...
int main(int argc, char** argv)
{
	...
	erydbassert(sessionId == 12345);
	erydbassert(stepId == 10);

	bs = dec->read(12345, 1);
	readBs(bs, sessionId, stepId);
	erydbassert(sessionId == 12345);
	erydbassert(stepId == 1);

	bs = dec->read(12345, 0);
	readBs(bs, sessionId, stepId);
	erydbassert(sessionId == 12345);
	erydbassert(stepId == 0);

	bs = dec->read(12345, 3);
	readBs(bs, sessionId, stepId);
	erydbassert(sessionId == 12345);
	erydbassert(stepId == 3);
