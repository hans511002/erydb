...
struct TupleInfo
{
	TupleInfo(uint32_t w=0, uint32_t o=0, uint32_t k=-1, uint32_t t=-1, uint32_t s=0, uint32_t p=0,
		execplan::erydbSystemCatalog::ColDataType dt=execplan::erydbSystemCatalog::BIT) :
	...
	uint32_t scale;
	uint32_t precision;
	execplan::erydbSystemCatalog::ColDataType dtype;
};
...
typedef std::map<execplan::erydbSystemCatalog::OID, execplan::erydbSystemCatalog::OID> DictOidToColOidMap;
...
typedef execplan::erydbSelectExecutionPlan::ReturnedColumnList RetColsVector;
...
struct TupleKeyInfo
{
	...
	std::map<uint32_t, execplan::erydbSystemCatalog::OID> tupleKeyToTableOid;
	std::map<uint32_t, execplan::erydbSystemCatalog::ColType> colType;
	std::map<uint32_t, execplan::erydbSystemCatalog::ColType> token2DictTypeMap;
...
struct JobInfo
{
	...
	std::map<UniqId, execplan::erydbSystemCatalog::ColType> vtableColTypes;
 ...
 *
 */
execplan::erydbSystemCatalog::OID isDictCol(const execplan::erydbSystemCatalog::ColType& colType);

/** @brief Determines if colType is a character column
 *
 */
bool isCharCol(const execplan::erydbSystemCatalog::ColType& colType);

/** @brief Returns OID associated with a table
 *
 */
execplan::erydbSystemCatalog::OID tableOid(const execplan::SimpleColumn* sc,
 ...
 *
 */
TupleInfo setExpTupleInfo(const execplan::erydbSystemCatalog::ColType& ct,
...
void makeJobSteps(execplan::erydbSelectExecutionPlan* csep, JobInfo& jobInfo,
	JobStepVector& querySteps, JobStepVector& projectSteps,
	DeliveredTableMap& deliverySteps);

void makeUnionJobSteps(execplan::erydbSelectExecutionPlan* csep, JobInfo& jobInfo,
...
bool compatibleColumnTypes(const execplan::erydbSystemCatalog::ColType& ct1,
                           const execplan::erydbSystemCatalog::ColType& ct2,
                           bool  forJoin = true);
bool compatibleColumnTypes(const execplan::erydbSystemCatalog::ColDataType& dt1, uint32_t scale1,
                           const execplan::erydbSystemCatalog::ColDataType& dt2, uint32_t scale2,
                           bool  forJoin = true);
