 ...
 *
 * Class JobListFactory creates a JobList object from a erydbExecutionPlan object
 */
...
public:
	 ...
	 *
	 * @param cplan the erydbExecutionPlan from which the JobList is constructed
	 */
	EXPORT static SJLP makeJobList(
		execplan::erydbExecutionPlan* cplan,
		ResourceManager& rm,
		bool tryTuple=false,
		bool isExeMgr = false);
