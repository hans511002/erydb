...
#include "../../utils/windowfunction/erydborderby.h"
#include "jobstep.h"
#include "rowgroup.h"
...
public:
   ...
   virtual ~WindowFunctionStep();
	...
	static void checkWindowFunction(execplan::erydbSelectExecutionPlan*, JobInfo&);
...
private:
	...
	boost::shared_ptr<execplan::erydbSystemCatalog>  fCatalog;
