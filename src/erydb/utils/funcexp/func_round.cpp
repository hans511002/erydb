...
erydbSystemCatalog::ColType Func_round::operationType(FunctionParm& fp, erydbSystemCatalog::ColType& resultType)
{
...
ERYDB_Decimal Func_round::getDecimalVal(Row& row,
							FunctionParm& parm,
							bool& isNull,
							erydbSystemCatalog::ColType& op_ct)
{
