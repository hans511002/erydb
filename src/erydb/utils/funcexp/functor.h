...
namespace execplan
{
extern const std::string colDataTypeToString(erydbSystemCatalog::ColDataType cdt);
}
...
public:
	...
	virtual execplan::erydbSystemCatalog::ColType operationType(FunctionParm& fp, execplan::erydbSystemCatalog::ColType& resultType) = 0;
