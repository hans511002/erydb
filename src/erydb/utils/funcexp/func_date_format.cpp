...
namespace helpers
{
const string ERYDB_date_format(const DateTime& dt, const string& format)
{
...
erydbSystemCatalog::ColType Func_date_format::operationType( FunctionParm& fp, erydbSystemCatalog::ColType& resultType )
{
