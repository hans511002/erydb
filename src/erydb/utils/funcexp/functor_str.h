...
public:
	...
	execplan::ERYDB_Decimal getDecimalVal(rowgroup::Row& row,
						...
						bool& isNull,
						execplan::erydbSystemCatalog::ColType& op_ct)
	{ return execplan::ERYDB_Decimal(atoll(getStrVal(row, fp, isNull, op_ct).c_str()),0,0); }
...
/** @brief Func_erydbpartition class
  */
class Func_erydbpartition : public Func_Str
{
public:
        Func_erydbpartition() : Func_Str("erydbpartition") {}
        virtual ~Func_erydbpartition() {}
