...
namespace funcexp
{
erydbSystemCatalog::ColType Func_coalesce::operationType( FunctionParm& fp, erydbSystemCatalog::ColType& resultType )
{
	return resultType;
}
...
execplan::ERYDB_Decimal Func_coalesce::getDecimalVal(rowgroup::Row& row,
						FunctionParm& parm,
						bool& isNull,
						execplan::erydbSystemCatalog::ColType& ct)
{
