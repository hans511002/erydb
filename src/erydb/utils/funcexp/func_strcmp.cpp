...
erydbSystemCatalog::ColType Func_strcmp::operationType(FunctionParm& fp, erydbSystemCatalog::ColType& resultType)
{
						...
						execplan::erydbSystemCatalog::ColType& op_ct)
{
	...
	int ret = utf8::erydb_strcoll(str.c_str(), str1.c_str());
