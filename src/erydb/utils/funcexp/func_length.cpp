...
namespace funcexp
{
erydbSystemCatalog::ColType Func_length::operationType( FunctionParm& fp, erydbSystemCatalog::ColType& resultType )
{
...
{
	if (fp[0]->data()->resultType().colDataType == erydbSystemCatalog::VARBINARY)
