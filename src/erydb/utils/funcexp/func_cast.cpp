...
erydbSystemCatalog::ColType Func_cast_signed::operationType( FunctionParm& fp, erydbSystemCatalog::ColType& resultType )
{
	return resultType;
}

erydbSystemCatalog::ColType Func_cast_unsigned::operationType( FunctionParm& fp, erydbSystemCatalog::ColType& resultType )
{
	return resultType;
}

erydbSystemCatalog::ColType Func_cast_char::operationType( FunctionParm& fp, erydbSystemCatalog::ColType& resultType )
{
	return resultType;
}

erydbSystemCatalog::ColType Func_cast_date::operationType( FunctionParm& fp, erydbSystemCatalog::ColType& resultType )
{
	return resultType;
}

erydbSystemCatalog::ColType Func_cast_datetime::operationType( FunctionParm& fp, erydbSystemCatalog::ColType& resultType )
{
	return resultType;
}

erydbSystemCatalog::ColType Func_cast_decimal::operationType( FunctionParm& fp, erydbSystemCatalog::ColType& resultType )
{
	return resultType;
}
	...
	switch (parm[0]->data()->resultType().colDataType)
	{
        ...
        case execplan::erydbSystemCatalog::UDOUBLE:
		{
			...
			if (value > (double) numeric_limits<int64_t>::max())
				...
				ret = numeric_limits<int64_t>::min() + 2; // ERYDB min for bigint
...
int64_t Func_cast_date::getIntVal(Row& row,
									...
									erydbSystemCatalog::ColType& operationColType)
{
	if (operationColType.colDataType == execplan::erydbSystemCatalog::DATE)
...
ERYDB_Decimal Func_cast_date::getDecimalVal(Row& row,
									FunctionParm& parm,
									bool& isNull,
									erydbSystemCatalog::ColType& operationColType)
{
...
int64_t Func_cast_date::getDatetimeIntVal(rowgroup::Row& row,
							FunctionParm& parm,
							bool& isNull,
							execplan::erydbSystemCatalog::ColType& operationColType)
{
	int64_t val;
	switch (parm[0]->data()->resultType().colDataType)
	{
...
ERYDB_Decimal Func_cast_datetime::getDecimalVal(Row& row,
									FunctionParm& parm,
									bool& isNull,
									erydbSystemCatalog::ColType& operationColType)
{
									...
									erydbSystemCatalog::ColType& operationColType)
{
	...
	ERYDB_Decimal decimal = Func_cast_decimal::getDecimalVal(row,
				parm,
				isNull,
				operationColType);
...
ERYDB_Decimal Func_cast_decimal::getDecimalVal(Row& row,
									FunctionParm& parm,
									bool& isNull,
									erydbSystemCatalog::ColType& operationColType)
{
