 ...
 * 
 */
public class EryDBOutputFormat<K  /*extends DBWritable*/, V> 
implements OutputFormat<K,V> {

  private static final Log LOG = LogFactory.getLog(EryDBOutputFormat.class);
...
{
	job.setOutputFormat(EryDBOutputFormat.class);
