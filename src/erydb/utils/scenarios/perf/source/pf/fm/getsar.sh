...
#
cd /tmp/$host1/sar/
smbclient //calweb/perf -Werydb -Uoamuser%erydb1 -c "cd ${host1};prompt OFF;mput *_$1_$host1.txt"
#
#------------------------------------------------------------------------------
# Execute the script on the other servers in the stack
#
/usr/local/erydb/bin/remote_command.sh $host2 qalpont! "/home/pf/auto/fm/sar.sh $1 $2 $3" 1
/usr/local/erydb/bin/remote_command.sh $host3 qalpont! "/home/pf/auto/fm/sar.sh $1 $2 $3" 1
/usr/local/erydb/bin/remote_command.sh $host4 qalpont! "/home/pf/auto/fm/sar.sh $1 $2 $3" 1
/usr/local/erydb/bin/remote_command.sh $host5 qalpont! "/home/pf/auto/fm/sar.sh $1 $2 $3" 1
#
# End of Script
