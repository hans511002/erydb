...
#
# Stopping the erydb software
/usr/local/erydb/bin/eryadmin stopsystem y ACK_YES
#
...
while [ $k -le $maxUMs ]; do
       /usr/local/erydb/bin/eryadmin enableModule um$k ACK_YES
       ((k++))
done
#-----------------------------------------------------------------------------
...
while [ $k -gt $numUMs ]; do
       /usr/local/erydb/bin/eryadmin disableModule um$k ACK_YES
       ((k--))
done
#-----------------------------------------------------------------------------
#Enable all PMs
...
while [ $k -le $maxPMs ]; do
       /usr/local/erydb/bin/eryadmin enableModule pm$k ACK_YES
       ((k++))
done
#-----------------------------------------------------------------------------
...
while [ $k -gt $numPMs ]; do
       /usr/local/erydb/bin/eryadmin disableModule pm$k ACK_YES
       ((k--))
done
#-----------------------------------------------------------------------------
echo *-*-*-*-*-*-*-*-*-*-*-*-*-*-*
