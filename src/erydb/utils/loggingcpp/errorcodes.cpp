...
namespace logging { 
  ...
  ErrorCodes::ErrorCodes(): fErrorCodes(), fPreamble("An unexpected condition within the query caused an internal processing error within EryDB. Please check the log files for more details. Additional Information: ")
  {
