...
#ifndef _my_pthread_h
#define localtime_r erydb_localtime_r
extern struct tm* erydb_localtime_r(const time_t*, struct tm*);
#define strtoll _strtoi64
#define strtoull _strtoui64
#define crc32 erydb_crc32
extern unsigned int erydb_crc32(const unsigned int, const unsigned char*, const size_t);
#endif
...
extern std::string ERYDBSysErrorStr(DWORD err);
