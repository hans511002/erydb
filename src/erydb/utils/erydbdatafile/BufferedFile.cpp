...
ssize_t BufferedFile::read(void *ptr, size_t count)
{
	...
	if( ERYDBLogger::isEnabled() )
		ERYDBLogger::logRW("read", m_fname, this, offset, count, progress);
...
ssize_t BufferedFile::write(const void *ptr, size_t count)
{
	...
	if( ERYDBLogger::isEnabled() )
		ERYDBLogger::logRW("write", m_fname, this, offset, count, progress);
...
int BufferedFile::flush()
{
	...
	if( ERYDBLogger::isEnabled() )
		ERYDBLogger::logNoArg(m_fname, this, "flush", rc);
