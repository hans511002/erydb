...
/**
 * BufferedFile implements the ERYDBDataFile for I/O to a C library FILE*
 * (via fopen, fwrite, fread, etc.).  See ERYDBDataFile.h for more documentation
 * on member functions.
 */
class BufferedFile : public ERYDBDataFile, boost::noncopyable
{
public:
