...
enum erydbDateTimeFormat
{
    ERYDBDATE_ENUM     = 1, // date format is: "YYYY-MM-DD"
    ERYDBDATETIME_ENUM = 2  // date format is: "YYYY-MM-DD HH:MI:SS"
};
...
struct Date
{
    ...
    // Construct a Date from a 64 bit integer erydb date.
    Date(uint64_t val) :
...
struct DateTime
{
    ...
    // Construct a DateTime from a 64 bit integer erydb datetime.
...
struct Time
{
    ...
    // Construct a Time from a 64 bit integer EryDB time.
    Time(int64_t val) :
...
/** @brief DataConvert is a component for converting string data to erydb format
  */
class DataConvert
{
public:
     ...
     */
    EXPORT static boost::any convertColumnData( const execplan::erydbSystemCatalog::ColType& colType,
   ...
   /**
    ...
    EXPORT static bool isNullData(execplan::ColumnResult* cr, int rownum, execplan::erydbSystemCatalog::ColType colType);
    static inline std::string decimalToString(int64_t value, uint8_t scale, execplan::erydbSystemCatalog::ColDataType colDataType);
    static inline void decimalToString(int64_t value, uint8_t scale, char* buf, unsigned int buflen, execplan::erydbSystemCatalog::ColDataType colDataType);
    ...
    EXPORT static execplan::erydbSystemCatalog::ColType convertUnionColType(std::vector<execplan::erydbSystemCatalog::ColType>&);
};
...
inline std::string DataConvert::decimalToString(int64_t value, uint8_t scale, execplan::erydbSystemCatalog::ColDataType colDataType)
{
    char buf[80];
                                         ...
                                         execplan::erydbSystemCatalog::ColDataType colDataType)
{
    ...
    // Taken from ha_erydb_impl.cpp
    
    //biggest erydb supports is DECIMAL(18,x), or 18 total digits+dp+sign for column
