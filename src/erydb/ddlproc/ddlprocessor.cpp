                ...
                case ddlpackage::DDL_CREATE_TABLE_STATEMENT:
                    {
                        ...
                        systemCatalogPtr->removeerydbSystemCatalog( createTableStmt.fSessionID );
                        systemCatalogPtr->removeerydbSystemCatalog( createTableStmt.fSessionID | 0x80000000);
                ...
                case ddlpackage::DDL_ALTER_TABLE_STATEMENT:
                    {
                    	...
                    	boost::shared_ptr<erydbSystemCatalog> systemCatalogPtr =
							erydbSystemCatalog::makeerydbSystemCatalog(alterTableStmt.fSessionID );
                        ...
                        systemCatalogPtr->removeerydbSystemCatalog( alterTableStmt.fSessionID );
                        systemCatalogPtr->removeerydbSystemCatalog( alterTableStmt.fSessionID | 0x80000000);
                ...
                case ddlpackage::DDL_DROP_TABLE_STATEMENT:
                    {
						...
						boost::shared_ptr<erydbSystemCatalog> systemCatalogPtr =
							erydbSystemCatalog::makeerydbSystemCatalog(dropTableStmt.fSessionID );
                        ...
                        systemCatalogPtr->removeerydbSystemCatalog( dropTableStmt.fSessionID );
                        systemCatalogPtr->removeerydbSystemCatalog( dropTableStmt.fSessionID | 0x80000000);
                ...
                case ddlpackage::DDL_TRUNC_TABLE_STATEMENT:
                    {
                        ...
                        boost::shared_ptr<erydbSystemCatalog> systemCatalogPtr =
						erydbSystemCatalog::makeerydbSystemCatalog(truncTableStmt.fSessionID);
                        ...
                        systemCatalogPtr->removeerydbSystemCatalog(truncTableStmt.fSessionID );
                        systemCatalogPtr->removeerydbSystemCatalog(truncTableStmt.fSessionID | 0x80000000);
				...
				case ddlpackage::DDL_MARK_PARTITION_STATEMENT:
                    {
                        ...
                        boost::shared_ptr<erydbSystemCatalog> systemCatalogPtr =
                        erydbSystemCatalog::makeerydbSystemCatalog(markPartitionStmt.fSessionID);
                        ...
                        systemCatalogPtr->removeerydbSystemCatalog(markPartitionStmt.fSessionID );
                        systemCatalogPtr->removeerydbSystemCatalog(markPartitionStmt.fSessionID | 0x80000000);
                    }
                    break;
				...
				case ddlpackage::DDL_RESTORE_PARTITION_STATEMENT:
                    {
                        ...
                        boost::shared_ptr<erydbSystemCatalog> systemCatalogPtr =
						erydbSystemCatalog::makeerydbSystemCatalog(restorePartitionStmt.fSessionID);
                        ...
                        systemCatalogPtr->removeerydbSystemCatalog(restorePartitionStmt.fSessionID );
                        systemCatalogPtr->removeerydbSystemCatalog(restorePartitionStmt.fSessionID | 0x80000000);
                    }
                    break;
				...
				case ddlpackage::DDL_DROP_PARTITION_STATEMENT:
                    {
                        ...
                        boost::shared_ptr<erydbSystemCatalog> systemCatalogPtr =
						erydbSystemCatalog::makeerydbSystemCatalog(dropPartitionStmt.fSessionID);
                        ...
                        systemCatalogPtr->removeerydbSystemCatalog(dropPartitionStmt.fSessionID );
                        systemCatalogPtr->removeerydbSystemCatalog(dropPartitionStmt.fSessionID | 0x80000000);
                    }
                    break;
...
void DDLProcessor::process()
{
    ...
    try
    {
        for (;;)
        {
			...
			{
				string ermsg;
				bool checkLicAllow = License::checkLicense(ermsg);
				if (!checkLicAllow){
					messageqcpp::ByteStream results;
					messageqcpp::ByteStream::byte status = DDLPackageProcessor::NOT_ACCEPTING_PACKAGES;
					results << status;
