...
//------------------------------------------------------------------------------
// Returns the number of IP addresses defined in the erydb.xml file
// return - uint32_t; the total number of IP addresses in the erydb.xml file
//------------------------------------------------------------------------------
uint32_t
...
//------------------------------------------------------------------------------
// Loads the UM module information from the erydb.xml file, so that we have
