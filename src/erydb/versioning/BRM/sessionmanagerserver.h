 ...
 *
 * This class uses 3 parameters from the erydb.xml file:
...
private:
	...
	execplan::erydbSystemCatalog::SCN _verID;
	execplan::erydbSystemCatalog::SCN _sysCatVerID;
	uint32_t systemState;

	std::map<SID, execplan::erydbSystemCatalog::SCN> activeTxns;
	typedef std::map<SID, execplan::erydbSystemCatalog::SCN>::iterator iterator;
