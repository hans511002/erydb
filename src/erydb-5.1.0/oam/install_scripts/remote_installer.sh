...
# erase package
#
send_user "Perform Old erydb Package erased from Module"
expect -re "# "
...
#
set timeout 30
send_user "Perform New erydb Package install on Module"
...
send "scp /usr/local/erydb/local/etc/$MODULE/*  $USERNAME@$SERVER:/etc/.\n"
expect -re "word: "
# send the password
send "$PASSWORD\n"
expect {
