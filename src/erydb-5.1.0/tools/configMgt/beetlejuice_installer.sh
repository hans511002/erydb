...
send "rm -f $PACKAGE\n"
#expect -re "#"
send "smbclient //cal6500/shared -Werydb -Uoamuser%erydb1 -c 'cd Iterations/$RELEASE/;prompt OFF;mget $PACKAGE'\n"
expect {
...
#
expect -re "#"
send_user "Erase Old erydb-oracle Package              "
send "ssh $USERNAME@$SERVER ' rpm -e --nodeps erydb-oracle'\n"
expect -re "word: "
# password for ssh
send "$PASSWORD\n"
# check return
...
send_user "\n"
expect -re "#"
send_user "Erase Old erydb-Mysql Package               "
send "ssh $USERNAME@$SERVER ' rpm -e --nodeps erydb-mysql'\n"
expect -re "word: "
# password for ssh
send "$PASSWORD\n"
# check return
...
send "ssh $USERNAME@$SERVER ' rpm -e --nodeps erydb'\n"
expect -re "word: "
# password for ssh
send "$PASSWORD\n"
# check return
