...
extern erydbSelectExecutionPlan* ParserCSEP;
extern boost::shared_ptr<erydbSystemCatalog> ParserCSC;
...
erydbSelectExecutionPlan* parseQuery(const string& query, const uint32_t sid)
{
	...
	boost::shared_ptr<erydbSystemCatalog> csc = erydbSystemCatalog::makeerydbSystemCatalog(sid);
	erydbSelectExecutionPlan* csep=0;
	csep = new erydbSelectExecutionPlan();
	...
	auto_ptr<erydbSelectExecutionPlan> scsep(csep);
