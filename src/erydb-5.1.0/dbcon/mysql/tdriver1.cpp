...
string toString(int64_t t1, unsigned scale)
{
	...
	//biggest erydb supports is DECIMAL(18,x), or 18 total digits+dp+sign
...
int main(int argc, char** argv)
{
	...
	xstr = toString(x, 2);
	erydbassert(xstr == "9999999999999999.99");
	...
	x = -1LL;
	xstr = toString(x, 16);
	erydbassert(xstr == "-.0000000000000001");
