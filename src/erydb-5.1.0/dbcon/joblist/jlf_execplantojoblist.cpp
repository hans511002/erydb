...
//X
		...
		else if ( erydbSystemCatalog::CHAR != ct.colDataType &&
				 erydbSystemCatalog::VARCHAR != ct.colDataType &&
				 erydbSystemCatalog::VARBINARY != ct.colDataType &&
		...
		else
		{
			...
			try
			{
				...
				if ((ct.colDataType == erydbSystemCatalog::DATE ||
