...
//			while (more)
//			{
//				// @bug 663 - Added fSwallowRows for erydb.caltrace(16) which is
	...
	fRm(jobInfo.rm)
{
	...
	isDictColumn = ((colType.colDataType == erydbSystemCatalog::VARCHAR && colType.colWidth > 7)
					|| (colType.colDataType == erydbSystemCatalog::CHAR && colType.colWidth > 8));
	fColType = colType;
	fPseudoType = 0;
