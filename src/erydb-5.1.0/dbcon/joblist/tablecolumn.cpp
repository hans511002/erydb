...
/** @brief constructor
*/
TableColumn::TableColumn(const execplan::erydbSystemCatalog::OID columnOID, const supportedType columnType) :
...
*/
void TableColumn::addToSysDataList(execplan::erydbSystemCatalog::NJLSysDataList& sysDataList, const std::vector<uint64_t>& rids) {
...
#if 0
void TableColumn::addToSysDataRids(execplan::erydbSystemCatalog::NJLSysDataList& sysDataList, const std::vector<uint64_t>& rids)
{
