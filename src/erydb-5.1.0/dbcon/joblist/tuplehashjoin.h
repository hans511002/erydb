...
public:
	...
	execplan::erydbSystemCatalog::OID tableOid() const { return fTableOID2; }
	execplan::erydbSystemCatalog::OID tableOid1() const { return fTableOID1; }
	execplan::erydbSystemCatalog::OID tableOid2() const { return fTableOID2; }
	void tableOid1(execplan::erydbSystemCatalog::OID tableOid1)
		{ fTableOID1 = tableOid1; }
	void tableOid2(execplan::erydbSystemCatalog::OID tableOid2)
	...
	void oid1(execplan::erydbSystemCatalog::OID oid) { fOid1 = oid; }
	execplan::erydbSystemCatalog::OID oid1() const { return fOid1; }
	void oid2(execplan::erydbSystemCatalog::OID oid) { fOid2 = oid; }
	execplan::erydbSystemCatalog::OID oid2() const { return fOid2; }
	void dictOid1(execplan::erydbSystemCatalog::OID oid) { fDictOid1 = oid; }
	execplan::erydbSystemCatalog::OID dictOid1() const { return fDictOid1; }
	void dictOid2(execplan::erydbSystemCatalog::OID oid) { fDictOid2 = oid; }
	execplan::erydbSystemCatalog::OID dictOid2() const { return fDictOid2; }
	...
	execplan::erydbSystemCatalog::OID smallSideKeyOID(uint32_t s, uint32_t k) const;
	execplan::erydbSystemCatalog::OID largeSideKeyOID(uint32_t s, uint32_t k) const;
...
private:
	...
	execplan::erydbSystemCatalog::OID fTableOID1;
	execplan::erydbSystemCatalog::OID fTableOID2;
	execplan::erydbSystemCatalog::OID fOid1;
	execplan::erydbSystemCatalog::OID fOid2;

	// v-table string join
	execplan::erydbSystemCatalog::OID fDictOid1;
	execplan::erydbSystemCatalog::OID fDictOid2;
