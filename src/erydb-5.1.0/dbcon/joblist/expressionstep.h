...
class ExpressionStep : public JobStep
{
  public:
	...
	execplan::erydbSystemCatalog::OID tableOid() const
	...
	const std::vector<execplan::erydbSystemCatalog::OID>& tableOids() const { return fTableOids; }
	...
	std::vector<execplan::erydbSystemCatalog::OID>& tableOids() { return fTableOids; }
  ...
  protected:
	...
	// columns accessed
	std::vector<execplan::erydbSystemCatalog::OID> fTableOids;
