...
namespace
{
typedef erydbSystemCatalog::OID OID_t;
typedef erydbSystemCatalog::ColType ColType_t;
typedef erydbSystemCatalog::ROPair ROPair_t;
...
string toString(const string& tb, const string& col)
{
	...
	OID_t colOID = csc->lookupOID(make_tcn("erydbsys", tb, col));
...
int main(int argc, char** argv)
{
	...
	string erydbsys("erydbsys");
	string table;

	table = "systable";
	rp = csc->tableRID(make_table(erydbsys, table));
