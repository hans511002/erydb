...
public:
	...
	/** @brief Creates a new erydbExecutionPlan from the ByteStream
	 *
	 * @param b The ByteStream to create it from
	 * @return A newly allocated erydbExecutionPlan
	 */
	static erydbExecutionPlan* createExecutionPlan(messageqcpp::ByteStream& b);
