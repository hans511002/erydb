...
boost::shared_ptr<erydbSystemCatalog> syscat;
erydbSystemCatalog::OID o;
erydbSystemCatalog::ColType ct;
   
void setUp() {
	syscat = erydbSystemCatalog::makeerydbSystemCatalog();
}

void tearDown() {
	erydbSystemCatalog::removeerydbSystemCatalog();
}
...
void test2()
{
	syscat->identity(erydbSystemCatalog::EC);
	test1();
}
