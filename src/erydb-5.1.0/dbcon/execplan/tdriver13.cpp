...
//x ------------The create view statement is being re-written as an inline view  ----- x/ 
        ...
        SimpleColumn *c1 = new SimpleColumn("erydb.FROMTABLE.c_count");
  	...
  	// Append returned columns to subselect 
        ...
        //subselect Filters 
        erydbSelectExecutionPlan::FilterTokenList subcsep_filterlist; 
	...
	// sub Group By List
        erydbSelectExecutionPlan::GroupByColumnList subcsep_groupbyList;
	...
	// Build Group By List
        ...
        //SimpleColumn *g1 = new SimpleColumn("erydb.FROMTABLE.c_count");
