...
static const char *const yytname[] =
{
  ...
  "CURRENT", "CURSOR", "ERYDB_DECIMAL", "DECLARE", "DEFAULT", "DELETE",
  "DESC", "ERYDB_DOUBLE", "ESCAPE", "EXISTS", "FETCH", "ERYDB_FLOAT", "FOR",
  "FOREIGN", "FOUND", "FROM", "GOTO", "GRANT", "ERYDB_GROUP", "HAVING", "IN",
