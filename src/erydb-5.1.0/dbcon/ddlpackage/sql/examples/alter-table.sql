...
ALTER TABLE erydb.tbl_name ADD COLUMN col_name char(1);
ALTER TABLE tbl_name ADD COLUMN col_name char(2) engine=erydb;
ALTER TABLE tbl_name ADD COLUMN col_name char(4) engine = erydb;
...
ALTER TABLE erydb.tbl_name ADD COLUMN col_name datetime not null;
ALTER TABLE tbl_name ADD COLUMN col_name float(25,10) null engine=erydb;
...
ALTER TABLE erydb.tbl_name ADD CONSTRAINT const_name check (col_name) (col_name > 0);
alter table tbl_name add check (col_name) (col_name > 0) DEFERRED engine=erydb;
...
alter table erydb.tbl_name DISABLE constraint const_name;
alter table tbl_name ENABLE constraint const_name engine=erydb;


-- test alter column
alter table erydb.tbl_name alter col_name drop not null;
alter table tbl_name alter col_name drop null engine=erydb;
...
-- test drop column
alter table erydb.tbl_name drop col_name engine=erydb;
...
alter table erydb.tbl_name rename col_name to col_name1;
alter table tbl_name rename column col_name to col_name1 engine=erydb;
...
ALTER TABLE tbl_name ADD COLUMN col_name float(10,2) NOT null auto_increment default 1000 primary key DEFERRED unique DISABLED check (col_name = 50) references tbl_name1(col_name) engine=erydb;


-- test big do all test
ALTER TABLE erydb.tbl_name 
	ADD (
