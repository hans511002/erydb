...
ERYDB_INSTALL_ROOT=$(EXPORT_ROOT)

INSTALL_ROOT=$(ERYDB_INSTALL_ROOT)
...
ERYDB_LIBRARY_PATH=$(EXPORT_ROOT)/lib
ERYDB_INCLUDE_PATH=$(EXPORT_ROOT)/include

ERYDB_COMMON_LIBS=-lwindowfunction -ljoblist -lexecplan -ljoiner -lrowgroup -lfuncexp -ludfsdk \
-loamcpp -lsnmpmanager -ldataconvert -lbrm -lcacheutils -lmessageqcpp -lloggingcpp -lconfigcpp -lrwlock \
-lcommon -lcompress -lxml2 -lerydbboot -lboost_erydb -lmysqlcl_erydb -lquerystats -lerydbdatafile -lquerytele \
-lthrift -lpthread -lrt
ERYDB_WRITE_LIBS=-lddlpackageproc -lddlpackage -ldmlpackageproc -ldmlpackage -lwriteengine -lwriteengineclient -lcompress -lcacheutils
ERYDB_SNMP_LIBS=-lnetsnmpagent -lnetsnmp -lnetsnmpmibs -lnetsnmphelpers
