...
class UmSocketSelector
{
	public:
		...
		/** @brief Accessor to total number of UM IP's in erydb.xml.
		 *
		 * @return Number of UM IP addresses read from erydb.xml.
		 */
...
class UmModuleIPs
{
	public:
		...
		/** @brief Accessor to number of IP's from erydb.xml for this UM.
		 *
		 * @return Number of IP addresses read from erydb.xml for this UM.
		 */
		uint32_t ipAddressCount() const
