...
public:
	...
	const execplan::erydbSystemCatalog::ColType& getColType() { return colType; }
	...
	bool willPrefetch();
	const uint64_t getEmptyRowValue( const execplan::erydbSystemCatalog::ColDataType dataType, const int width ) const;
