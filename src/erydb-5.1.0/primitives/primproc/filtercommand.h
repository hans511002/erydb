...
class FilterCommand : public Command
{
	public:
		...
		void setColTypes(const execplan::erydbSystemCatalog::ColType& left,
	...
	protected:
		...
		execplan::erydbSystemCatalog::ColType leftColType;
		execplan::erydbSystemCatalog::ColType rightColType;
