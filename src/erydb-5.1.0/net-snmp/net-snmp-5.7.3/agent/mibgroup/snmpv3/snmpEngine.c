                  ...
                  u_char * statP, oid * name, size_t name_len)
{
    ...
    u_char          engineERYDBuf[SNMP_MAXBUF_MEDIUM];
    int             engineERYDBufLen = 0;
    ...
    if (action == COMMIT) {
        engineERYDBufLen =
            snmpv3_get_engineID(engineERYDBuf, SNMP_MAXBUF_MEDIUM);
        /*
         * set our local engineTime in the LCD timing cache 
         */
        snmpv3_set_engineBootsAndTime(long_ret,
                                      snmpv3_local_snmpEngineTime());
        set_enginetime(engineERYDBuf, engineERYDBufLen,
