...
int main(int argc, char *argv[])
{
   ...
   for( int i = 1; i < argc; i++ )
   {
	...
	if ( DBMS ) {
		...
		else
		{
			...
			{	
				...
				if ( WEXITSTATUS(ret) == 0) {
					...
					system("echo ' ' >> erydbSupportReport.txt");
					system("echo '******************** DBMS Mysql erydb System Column  ********************' >> erydbSupportReport.txt");
					system("echo ' ' >> erydbSupportReport.txt");
					...
					system("echo ' ' >> erydbSupportReport.txt");
					system("echo '******************** DBMS Mysql erydb System Table  ********************' >> erydbSupportReport.txt");
					system("echo ' ' >> erydbSupportReport.txt");
					...
					system("echo ' ' >> erydbSupportReport.txt");
					system("echo '******************** DBMS Mysql erydb System Catalog Data ********************' >> erydbSupportReport.txt");
					system("echo ' ' >> erydbSupportReport.txt");
					...
					system("echo ' ' >> erydbSupportReport.txt");
					system("echo '******************** DBMS Mysql erydb System Table Data ********************' >> erydbSupportReport.txt");
					system("echo ' ' >> erydbSupportReport.txt");
					...
					system("echo ' ' >> erydbSupportReport.txt");
					system("echo '******************** DBMS Mysql erydb Usernames ********************' >> erydbSupportReport.txt");
					system("echo ' ' >> erydbSupportReport.txt");
					...
					system("echo ' ' >> erydbSupportReport.txt");
					system("echo '******************** DBMS Mysql EryDB variables ********************' >> erydbSupportReport.txt");
					system("echo ' ' >> erydbSupportReport.txt");
		...
		system("echo ' ' >> erydbSupportReport.txt");
		system("echo '******************** DBMS Mysql EryDB config file ********************' >> erydbSupportReport.txt");
		system("echo ' ' >> erydbSupportReport.txt");
		cmd = "echo '################# cat /mysql/my.cnf ################# ' >> erydbSupportReport.txt";
		system(cmd.c_str());
		cmd = "echo ' ' >> erydbSupportReport.txt";
		system(cmd.c_str());
