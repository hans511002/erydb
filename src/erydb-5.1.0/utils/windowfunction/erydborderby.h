...
//  $Id: erydborderby.h 4012 2013-07-24 21:04:45Z pleblanc $


/** @file */

#ifndef ERYDB_ORDER_BY_H
#define ERYDB_ORDER_BY_H
...
// base classs for order by clause used in ERYDB
