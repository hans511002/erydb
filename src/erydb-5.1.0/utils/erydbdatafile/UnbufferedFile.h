...
/**
 * UnbufferedFile implements the ERYDBDataFile for I/O to a standand kernel
 * fd (via open, write, read, etc.).  See ERYDBDataFile.h for more documentation
 * on member functions.
 */
class UnbufferedFile : public ERYDBDataFile, boost::noncopyable
{
public:
