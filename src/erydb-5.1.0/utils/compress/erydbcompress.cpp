...
/******************************************************************************************
* $Id: erydbcompress.cpp 3907 2013-06-18 13:32:46Z dcathey $
*
******************************************************************************************/
#include <cstring>
#include <iostream>
...
#define ERYDBCOMP_DLLEXPORT
#include "erydbcompress.h"
#undef ERYDBCOMP_DLLEXPORT
...
const int      PTR_SECTION_OFFSET = compress::ERYDBCompressInterface::HDR_BUF_LEN;
...
union CompressedDBFileHeaderBlock
{
	...
	char fDummy[compress::ERYDBCompressInterface::HDR_BUF_LEN];
};
...
namespace compress
{
#ifndef SKIP_ERYDB_COMPRESSION

ERYDBCompressInterface::ERYDBCompressInterface(unsigned int numUserPaddingBytes) :
	fNumUserPaddingBytes(numUserPaddingBytes)
{ }

ERYDBCompressInterface::~ERYDBCompressInterface()
{ }
...
*/
bool ERYDBCompressInterface::isCompressionAvail(int compressionType) const
{
...
//------------------------------------------------------------------------------
int ERYDBCompressInterface::compressBlock(const char* in,
	const size_t   inLen,
	unsigned char* out,
...
//------------------------------------------------------------------------------
int ERYDBCompressInterface::uncompressBlock(const char* in, const size_t inLen, unsigned char* out,
	unsigned int& outLen) const
{
	bool comprc = false;
	size_t ol = 0;
...
//------------------------------------------------------------------------------
int ERYDBCompressInterface::verifyHdr(const void* hdrBuf) const
{
...
//------------------------------------------------------------------------------
int ERYDBCompressInterface::getPtrList(const char* ptrBuf,
...
//------------------------------------------------------------------------------
int ERYDBCompressInterface::getPtrList(const char* hdrBuf, CompChunkPtrList& chunkPtrs ) const
{
...
//------------------------------------------------------------------------------
unsigned int ERYDBCompressInterface::getPtrCount(const char* ptrBuf,
...
//------------------------------------------------------------------------------
unsigned int ERYDBCompressInterface::getPtrCount(const char* hdrBuf) const
{
...
//------------------------------------------------------------------------------
void ERYDBCompressInterface::storePtrs(const std::vector<uint64_t>& ptrs,
	void* ptrBuf,
...
// Wrapper of above method for backward compatibility
//------------------------------------------------------------------------------
void ERYDBCompressInterface::storePtrs(const std::vector<uint64_t>& ptrs, void* ptrBuf) const
{
...
//------------------------------------------------------------------------------
void ERYDBCompressInterface::initHdr(void* hdrBuf, int compressionType) const
{
...
//------------------------------------------------------------------------------
void ERYDBCompressInterface::initHdr(void* hdrBuf,void* ptrBuf,int compressionType,int hdrSize) const
{
...
//------------------------------------------------------------------------------
void ERYDBCompressInterface::setBlockCount(void* hdrBuf, uint64_t count) const
{
...
//------------------------------------------------------------------------------
uint64_t ERYDBCompressInterface::getBlockCount(const void* hdrBuf) const
{
...
//------------------------------------------------------------------------------
void ERYDBCompressInterface::setHdrSize(void* hdrBuf, uint64_t size) const
{
...
//------------------------------------------------------------------------------
uint64_t ERYDBCompressInterface::getHdrSize(const void* hdrBuf) const
{
...
// block number.
//------------------------------------------------------------------------------
void ERYDBCompressInterface::locateBlock(unsigned int block,
...
// bytes to 0.
//------------------------------------------------------------------------------
int ERYDBCompressInterface::padCompressedChunks(unsigned char* buf,
	unsigned int& len,
...
/* static */
uint64_t ERYDBCompressInterface::maxCompressedSize(uint64_t uncompSize)
{
	return (snappy::MaxCompressedLength(uncompSize) + HEADER_SIZE);
}

int ERYDBCompressInterface::compress(const char *in, size_t inLen, char *out,
		size_t *outLen) const
{
...
int ERYDBCompressInterface::uncompress(const char *in, size_t inLen, char *out) const
{
	return !(snappy::RawUncompress(in, inLen, out));
}

/* static */
bool ERYDBCompressInterface::getUncompressedSize(char *in, size_t inLen, size_t *outLen)
{
