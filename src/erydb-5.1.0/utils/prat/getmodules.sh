...
#***************************************************************************/
#
moduletype=`cat /usr/local/erydb/local/module`
...
# issue erydb console command and send the output to a file
/usr/local/erydb/bin/eryadmin getsystemnetworkconfig ACK_YES |
