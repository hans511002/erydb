...
public:
	...
	void test1() {
		Config* c1 = Config::makeConfig("./erydb.xml");
		string value;
	...
	void test3() {
		...
		{
			c1 = Config::makeConfig("./erydb.xml");
			value = c1->getConfig("Message", "Name");
	...
	void test4() {
		...
		::unlink("./erydb.xml.new");
		c1->write("./erydb.xml.new");
		...
		c1->write("./erydb.xml.new");
		Config* c2 = Config::makeConfig("./erydb.xml.new");
	...
	void test6() {
		Config* c1 = Config::makeConfig("./Xerydb.xml");
	...
	void test11() {
		...
		CPPUNIT_ASSERT(stat("./erydb.xml.new", &stat_buf) == 0);

		Config* c1 = Config::makeConfig("./erydb.xml.new");

		value = c1->getConfig("Message", "Name");
		CPPUNIT_ASSERT(value == "Message");

		utime_buf.actime = utime_buf.modtime = stat_buf.st_mtime + 1;
		CPPUNIT_ASSERT(utime("./erydb.xml.new", &utime_buf) == 0);
