...
{
    fLogDirName = ERYDBreadRegistry("") + "\\log";
    fLogFileName = ERYDBreadRegistry("") + "\\log\\EryDBLog.txt";
    fTimeFileName = ERYDBreadRegistry("") + "\\log\\EryDBLastArchive.dat";
