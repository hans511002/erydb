...
erydbSystemCatalog::ColType Func_sec_to_time::operationType(FunctionParm& fp, erydbSystemCatalog::ColType& resultType)
{
	return resultType;
}
							...
							erydbSystemCatalog::ColType& ct)
{
	...
	int64_t val = 0;
	erydbSystemCatalog::ColType curCt = parm[0]->data()->resultType();
...
execplan::ERYDB_Decimal Func_sec_to_time::getDecimalVal(rowgroup::Row& row,
						FunctionParm& parm,
						bool& isNull,
						execplan::erydbSystemCatalog::ColType& op_ct)
{
