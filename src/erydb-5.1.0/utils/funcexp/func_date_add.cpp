...
erydbSystemCatalog::ColType Func_date_add::operationType( FunctionParm& fp, erydbSystemCatalog::ColType& resultType )
{
	resultType.colDataType = erydbSystemCatalog::DATETIME;
							...
							erydbSystemCatalog::ColType& ct)
{
	...
	execplan::erydbSystemCatalog::ColType ct3 = parm[3]->data()->resultType();
	if ((ct3.colDataType == execplan::erydbSystemCatalog::CHAR ||
	     ct3.colDataType == execplan::erydbSystemCatalog::VARCHAR) &&
