...
namespace funcexp
{
erydbSystemCatalog::ColType Func_rpad::operationType(FunctionParm& fp, erydbSystemCatalog::ColType& resultType)
{
						...
						execplan::erydbSystemCatalog::ColType&)
{
    ...
    size_t padlen = utf8::erydb_mbstowcs(wcpad, pad.c_str(), padwclen+1);
