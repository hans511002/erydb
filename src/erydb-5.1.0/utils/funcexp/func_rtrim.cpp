...
erydbSystemCatalog::ColType Func_rtrim::operationType(FunctionParm& fp, erydbSystemCatalog::ColType& resultType)
{
						...
						execplan::erydbSystemCatalog::ColType&)
{
	...
	// utf8::erydb_mbstowcs could return -1 if there is bad chars
	...
	// erydb_mbstowcs could return -1 if there is bad chars
