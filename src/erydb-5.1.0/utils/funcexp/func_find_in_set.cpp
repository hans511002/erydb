...
erydbSystemCatalog::ColType Func_find_in_set::operationType( FunctionParm& fp, erydbSystemCatalog::ColType& resultType )
{
	return resultType;
}
...
execplan::ERYDB_Decimal Func_find_in_set::getDecimalVal(rowgroup::Row& row,
						FunctionParm& fp,
						bool& isNull,
