 ...
 * 6. restart all the EryDB servers and MySQL server
...
public:
	...
	/**
	 * Returns an EryDB integer representation of a date result of the function.
	 *
	...
	/**
	 * Returns an EryDB integer representation of a datetime result of the function.
	 *
	 * Check the date/time functions in ~/utils/funcexp for implementation
	 * example of this API.
	 */
