...
int ProcessManager::addModule(oam::DeviceNetworkList devicenetworklist, std::string password, bool manualFlag)
{
	...
	if ( packageType != "binary") {
		...
		if ( packageType == "deb" )
			separator = "_";
		//mariadb
		erydbPackage = homedir + "/erydb-*" + separator + systemsoftware.Version + "-" + systemsoftware.Release + "*." + packageType;
		mysqlPackage = homedir + "/erydb-storage-engine" + separator + systemsoftware.Version + "-" + systemsoftware.Release + "*." + packageType;
		mysqldPackage = homedir + "/erydb-mysql" + separator + systemsoftware.Version + "-" + systemsoftware.Release + "*." + packageType;
		erydbPackage1 = homedir + "/erydb-libs" + separator + systemsoftware.Version + "-" + systemsoftware.Release + "*." + packageType;
		erydbPackage2 = homedir + "/erydb-enterprise" + separator + systemsoftware.Version + "-" + systemsoftware.Release + "*." + packageType;
	}
	else
	{
		erydbPackage = homedir + "/erydb*" + systemsoftware.Version + "-" + systemsoftware.Release + "*.bin.tar.gz";
		mysqlPackage = erydbPackage;
		mysqldPackage = erydbPackage;
	}
