...
typedef struct st_order {
  ...
  */
  ...
  uint   nulls;                         /* @EryDB. For window function order by clause 
...
public:
  ...
  */
  ...
  inline bool isEryDB()
  {
    ...
    if (s && s->db_plugin && (strcmp((*s->db_plugin)->name.str, "EryDB") == 0))
#else
    if (s && s->db_plugin && (strcmp(s->db_plugin->name.str, "EryDB") == 0))
#endif
      return true;
