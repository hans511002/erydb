                 ...
                 ha_rows *found_return, ha_rows *updated_return)
{
  ...
  */
  ...
  // @EryDB. Add isEryDBDML to make sure it's EryDB dml stmt.
  ...
  */
  ...
  if (error < 0 && !thd->lex->analyze_stmt)
  {
	...
	//@Erydb found and updated aren't correct for UPDATE. Use row_count_func instead.
	if ((thd->erydb_vtable.isEryDBDML))
...
bool multi_update::send_eof()
{
  ...
  */
  ...
  if (!thd->lex->analyze_stmt)
  {
	...
	//@Erydb don't set row count on thd to push row count to the front
