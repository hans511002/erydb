...
enum enum_query_type
{
  ...
  /// EryDB post process to customerize item::print() functions.
  QT_ERYDB=(1<<10),
  /// EryDB customized item:print() without quote delimiter
  QT_ERYDB_NO_QUOTE=(1<<11),
  /// EryDB for union view as derived table. no view name is appended to the table alias.
  QT_ERYDB_DERIVED=(1<<12)
};
