...
SET(CMAKE_INSTALL_PREFIX "/usr/local/erydb/mysql")
...
## dhill
SET(ERYDB_DEBIAN_PACKAGE_NAME "erydb")
...
SET(CPACK_PACKAGE_FILE_NAME "${ERYDB_DEBIAN_PACKAGE_NAME}-${CPACK_DEBIAN_PACKAGE_VERSION}-${CPACK_DEBIAN_PACKAGE_RELEASE}-${ERYDB_BIT}-${DEB}")
SET(ERYDB_NO_DASH_VERSION ${CPACK_DEBIAN_PACKAGE_VERSION})
...
SET(CPACK_DEBIAN_PACKAGE_DEPENDS "erydb-common")
...
SET(CPACK_DEBIAN_SERVER_PACKAGE_DEPENDS "${CPACK_DEBIAN_PACKAGE_DEPENDS}, erydb-client")
