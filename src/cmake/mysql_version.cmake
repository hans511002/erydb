...
MACRO(GET_MYSQL_VERSION)
  ...
  MYSQL_GET_CONFIG_VALUE("ERYDB_VERSION_MAJOR" ERYDB_MAJOR_VERSION)
  MYSQL_GET_CONFIG_VALUE("ERYDB_VERSION_MINOR" ERYDB_MINOR_VERSION)
  MYSQL_GET_CONFIG_VALUE("ERYDB_VERSION_PATCH" ERYDB_PATCH_VERSION)
  MYSQL_GET_CONFIG_VALUE("ERYDB_VERSION_EXTRA" ERYDB_EXTRA_VERSION)
  MYSQL_GET_CONFIG_VALUE("ERYDB_VERSION_RELEASE" ERYDB_RELEASE_VERSION)
...
IF(NOT "${MAJOR_VERSION}" MATCHES "[0-9]+" OR
  ...
  SET(ERYDB_VERSION "${ERYDB_MAJOR_VERSION}.${ERYDB_MINOR_VERSION}.${ERYDB_PATCH_VERSION}${ERYDB_EXTRA_VERSION}")
  SET(ERYDB_RELEASE "${ERYDB_RELEASE_VERSION}")
  MESSAGE(STATUS "MariaDB-Erydb ${VERSION}")
  MESSAGE(STATUS "Erydb ${ERYDB_VERSION}")
  ...
  SET(PACKAGE_VERSION ${ERYDB_VERSION})
  SET(PACKAGE_RELEASE ${ERYDB_RELEASE})
ENDMACRO()
...
IF(NOT COMPILATION_COMMENT)
  SET(COMPILATION_COMMENT "Erydb ${ERYDB_VERSION}-${ERYDB_RELEASE}")
ENDIF()
...
IF(NOT CPACK_SOURCE_PACKAGE_FILE_NAME)
  SET(CPACK_SOURCE_PACKAGE_FILE_NAME "erydb-${VERSION}")
ENDIF()
SET(CPACK_PACKAGE_CONTACT "Erydb <hans511002@sohu.com>")
SET(CPACK_PACKAGE_VENDOR "MariaDB AB")
SET(CPACK_SOURCE_GENERATOR "TGZ")

# Defintions for windows version resources
SET(PRODUCTNAME "Erydb Server")
